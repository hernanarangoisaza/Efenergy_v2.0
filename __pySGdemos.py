...
layout = [  [sg.Text('Demonstration of Multiline Element\'s ability to show multiple colors ')],
            ...
            [sg.B('Plain'), sg.Button('Text Blue Line'), sg.Button('Text Green Line'), sg.Exit()],
...
while True:
    ...
    if 'Background Green' in event:
        window[MLINE_KEY].update('This is Green Background', background_color_for_value='green', append=True)
